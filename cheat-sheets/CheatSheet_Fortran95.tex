...
\textbf{Standard-Funktionen für Felder:} \lstinline|maxval, minval| geben Minimum und Maximum für Zahlen zurück, \listline|maxloc, minloc| die entsprechenden Indizes als Felder, \lstinline|sum, size| geben Summe und Anzahl aller Feldwerte zurück
