...
\lstdefinelanguage{Fortran95Konkret}{ % keine <...> Platzhalter
  ...
  morekeywords=[5]{integer, real, double, precision, complex, logical, character, implicit, none, parameter, dimension, namelist, contains, allocatable, optional},  % Datentypen, Deklaration etc
...
\section{Deklaration und Operatoren}
...
\textbf{Strings aus/mit numerischen Variablen generieren:} über write-Befehl mit Format (siehe \cref{sec:formatierung}),z.B. \lstinline|write(<charactervar>, <format>) <numerical1>, <character>, <numerical2>|
