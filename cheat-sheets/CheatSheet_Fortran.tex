...
\lstdefinelanguage{Fortran95Konkret}{ % keine <...> Platzhalter
  ...
  morekeywords=[3]{write, read, close, rewind, backspace, inquire, mod, nint, abs, repeat, trim, command_argument_count, get_command_argument, reshape, dot_product, maxval, minval, maxloc, minloc, sum, size},  % built-in Prozeduren/Funktionen
...
\lstdefinelanguage{Fortran95Abstrakt}{ % keine <...> Platzhalter
